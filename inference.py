...
class Inference:
    ...
    def prepare_data(self):
        ...
        self.valid_ds = CloudDataset(
            files=files[-3:],  # 3 days of validation data
...
if __name__ == "__main__":
    ...
    with wandb.init(project=PROJECT_NAME, job_type=JOB_TYPE, config=config, tags=["ddpm", config.model_name]):
